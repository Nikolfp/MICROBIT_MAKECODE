...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/microbit_makecode/](https://nikolfp.github.io/microbit_makecode/)
...
* αναζήτηση για **https://github.com/nikolfp/microbit_makecode** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/microbit_makecode** και κάντε κλικ στην εισαγωγή
